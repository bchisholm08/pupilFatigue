...
if (experiment == 1) {
subList <- c('P01', 'P02', 'P03', 'P04', 'P05', 'P06', 'P07', 'P08', 'P09', 'P10',
...
excludeSubjects <- c('P01','P02', 'P35', 'HI49')   # some bug with P02 subjID data, excluded for now 
...
subList <- subList[!(subList %in% excludeSubjects)]
} else {
