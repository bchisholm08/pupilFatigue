...
# GAMM models... 
```{r}
# Model pupil ~ s(time) + condOrder (if meaningful) with a random intercept for subject.

# If condOrder is categorical, might convert to a factor.
