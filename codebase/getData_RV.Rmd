...
getRData <- function(data) {
  ...
  if (data == 1 ){
    ...
    purl("M:/Lab_Shared/Brady_C/Projects/pupilEEG_fatigue/statistics/scripts/codebase/getSubjID_RV.Rmd", output = "getSubjID_RV.R")
source("getSubjID_RV.R")
  subjIDS <- getSubjList(1)
    ...
    downSampledDataDirectory <- "M:/Lab_Shared/Brady_C/Projects/pupilEEG_fatigue/statistics/scripts/downSampledData"
    
    # try to allocate space for data frame for efficiency 
